...
const (
	...
	VALUES ($1, $2, $3, $4, $5, $6)`
	infoInvoice        = `SELECT invoice_id, state, to_address, amount, currency FROM payments WHERE invoice_id = $1`
	...
	getPrivateKey      = `SELECT private_key FROM payments WHERE invoice_id = $1`
)
